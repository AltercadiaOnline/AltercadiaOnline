// @ts-nocheck
import { purgeAuthoritativeCharacterEconomy, resetAuthoritativePlayerEconomyToEmpty, } from '../../Economy/economyStore.js';
 ...
 */
export function purgeCharacterRuntimeState(playerId, characterId) {
...
export function resetNewCharacterEconomy(playerId, characterId) {
