...
const NPC_LORE_PROFILES: readonly NpcLoreProfile[] = [
  ...
  {
    npcId: 'operario_linha4',
    displayName: 'Operário da Linha 4',
    epithet: 'o Sinal Fantasma',
    role: 'Contact opcional do contrato da estação desativada.',
    district: 'Estação da Linha 4 — metrô morto',
    greeting: 'O implante travou. O dump do código ainda está em mim — eu não volto pro turno.',
    biography: [
      'Serviço de linha NexGrid. Depois do vazamento da diretoria, o implante de turno congelou em vermelho de emergência.',
      'Escondeu-se na estação desativada. Se aparecer na rua, o grid acha. O dump importa mais do que ele.',
    ],
    motivation: 'Que alguém extraia o código e o deixe fora do registro.',
    rumor: 'Quem encosta no terminal ouve o mesmo bipe do implante dele — atrasado meio segundo.',
  },
  {
    npcId: 'contrabandista',
    displayName: 'Contrabandista',
    epithet: 'o Carregador de Chaves',
    role: 'Contact de rescue do contrato de cripto-chaves.',
    district: 'Beco — caixotes e fumaça de bueiro',
    greeting: 'As chaves estão comigo. Tira daqui antes dos capangas voltarem.',
    biography: [
      'Traficante de hardware, não de rua comum. Placas, portas e chaves-mestre dos distritos cabem na mochila.',
      'Os capangas não querem o corpo. Querem o que está no bolso. O Quadro paga quem chega primeiro.',
    ],
    motivation: 'Sair do beco com as chaves ainda nele — ou em alguém que assinou o contrato.',
    rumor: 'A LED âmbar no pescoço pisca no mesmo ritmo das fechaduras NexGrid do quarteirão.',
  },
  {
    npcId: 'receptador',
    displayName: 'Receptador',
    epithet: 'o Banco da Mesa',
    role: 'Contact do relógio de ouro — segura, não usa.',
    district: 'Beco — banca improvisada',
    greeting: 'Relógio quente, preço frio. Não pergunto de onde veio.',
    biography: [
      'Intermediário. O relógio de executivo Vórtex é mercadoria, não joia. Mesa, lupa, lâmpada amarela.',
      'Trata o escolhido como cliente. O Quadro trata ele como ponto de coleta.',
    ],
    motivation: 'Desovar o relógio antes da corporação rastrear o pulso criptografado.',
    rumor: 'A caixa de veludo tem um selo Vórtex rasgado — ele jura que já veio assim.',
  },
  {
    npcId: 'ferreiro',
