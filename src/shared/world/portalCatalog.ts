...
export const PORTAL_CATALOG: readonly PortalCatalogEntry[] = [
  ...
  {
    portalId: 'city_portal_towerpower',
    label: 'Torre de Poder',
    direction: 'east',
    sourceConstructLayout: 'cidade_01',
    targetMapId: 'tower_gate',
    targetConstructLayout: 'entradatorredopoder',
    arrivalPortalId: 'farm_portal_south2',
    arrivalOffset: { dx: 0, dy: -2 },
  },
  {
    portalId: 'farm_portal_south2',
    label: 'Retorno à Cidade',
    direction: 'south',
    sourceConstructLayout: 'entradatorredopoder',
    targetMapId: 'city_01',
    targetConstructLayout: 'cidade_01',
    arrivalPortalId: 'city_portal_towerpower',
    arrivalOffset: { dx: -2, dy: 0 },
  },
];
