...
export const MERCENARY_QUEST_BANDS: readonly MercenaryQuestBand[] = [
  {
    ...
    brief:
      'Contratos de rua: favores sujos, pequenas investigações e proteção barata.',
  },
  {
    tier: 2,
    minLevel: 11,
    ...
    brief:
      'Infiltração, chantagem leve e segredos de figuras do distrito.',
  },
  {
    tier: 3,
    minLevel: 31,
    ...
    brief:
      'Corporações menores, dossiês pesados e escolhas com cheiro de pólvora.',
  },
];
