...
export const CREATURE_DROP_TABLE: readonly CreatureDropEntry[] = [
  ...
  { creatureId: 'spider', creatureName: 'Aranha', zoneId: ZoneId.Zone1, archetypeId: CreatureArchetypeId.UrbanScavenger, genericDropIds: ['spider_web', 'spider_venom'], equipableItemId: 'black_chitin_ring' },
  {
    ...
    creatureName: 'Centopeia',
    zoneId: ZoneId.Zone2,
    archetypeId: CreatureArchetypeId.MetroAnomaly,
    genericDropIds: ['centipede_segment', 'articulated_jaw'],
    equipableItemId: 'hundred_feet_boots',
    alternateEquipableItemIds: ['segmented_pants', 'articulated_amulet'],
  },
  {
    creatureId: 'slime',
    creatureName: 'Slime',
    zoneId: ZoneId.Zone2,
    archetypeId: CreatureArchetypeId.MetroAnomaly,
    genericDropIds: ['conductive_slime', 'slime_core'],
    equipableItemId: 'electric_slime_ring',
    alternateEquipableItemIds: ['conductive_plate_armor', 'gel_fiber_pants'],
  },
  {
    creatureId: 'humanoid',
    creatureName: 'Humanoide',
    zoneId: ZoneId.Zone2,
    archetypeId: CreatureArchetypeId.MetroAnomaly,
    genericDropIds: ['bones'],
    equipableItemId: 'pulsing_rift_amulet',
    alternateEquipableItemIds: ['rift_woven_pants'],
  },
  {
    creatureId: 'golem',
    creatureName: 'Gólem',
    zoneId: ZoneId.Zone2,
    archetypeId: CreatureArchetypeId.MetroAnomaly,
    genericDropIds: ['molten_beam'],
    equipableItemId: 'rail_armor',
    alternateEquipableItemIds: ['molten_beam_amulet', 'molten_rail_helm'],
  },
  {
    creatureId: 'specter',
    creatureName: 'Espectro',
    zoneId: ZoneId.Zone2,
    archetypeId: CreatureArchetypeId.MetroAnomaly,
    genericDropIds: ['translucent_essence'],
    equipableItemId: 'spectral_mantle',
    alternateEquipableItemIds: ['translucent_amulet'],
  },
  { creatureId: 'minotaur', creatureName: 'Minotauro', zoneId: ZoneId.Zone3, archetypeId: CreatureArchetypeId.ParkingPredator, genericDropIds: ['minotaur_horn'], equipableItemId: 'steel_horn_helm' },
  ...
  { creatureId: 'gargoyle', creatureName: 'Gargoyle', zoneId: ZoneId.Zone3, archetypeId: CreatureArchetypeId.ParkingPredator, genericDropIds: ['gargoyle_wing'], equipableItemId: 'gargoyle_chest' },
  ...
  { creatureId: 'serpent', creatureName: 'Serpente', zoneId: ZoneId.Zone4, archetypeId: CreatureArchetypeId.RooftopHunter, genericDropIds: ['common_scale', 'serpent_tooth'], equipableItemId: 'scale_pants' },
  ...
  { creatureId: 'wasp', creatureName: 'Vespa', zoneId: ZoneId.Zone4, archetypeId: CreatureArchetypeId.RooftopHunter, genericDropIds: ['cutting_wing', 'energy_stinger'], equipableItemId: 'wasp_boots' },
  { creatureId: 'werewolf', creatureName: 'Lobisomem', zoneId: ZoneId.Zone4, archetypeId: CreatureArchetypeId.RooftopHunter, genericDropIds: ['werewolf_fur', 'torn_claw'], equipableItemId: 'wolf_helmet' },
  { creatureId: 'crocodile', creatureName: 'Crocodilo', zoneId: ZoneId.Zone5, archetypeId: CreatureArchetypeId.DimensionalElite, genericDropIds: ['crocodile_scale', 'colossal_tooth'], equipableItemId: 'croco_pants' },
  { creatureId: 'sewer_golem', creatureName: 'Gólem de Esgoto', zoneId: ZoneId.Zone5, archetypeId: CreatureArchetypeId.DimensionalElite, genericDropIds: ['solidified_mud', 'fused_debris'], equipableItemId: 'debris_ring' },
  { creatureId: 'hydra', creatureName: 'Hidra', zoneId: ZoneId.Zone5, archetypeId: CreatureArchetypeId.DimensionalElite, genericDropIds: ['common_scale', 'hydra_tooth'], equipableItemId: 'three_heads_necklace' },
  { creatureId: 'cyclops', creatureName: 'Ciclope', zoneId: ZoneId.Zone5, archetypeId: CreatureArchetypeId.DimensionalElite, genericDropIds: ['fist_chunk', 'dimensional_rock'], equipableItemId: 'cyclops_eye' },
  { creatureId: 'wraith', creatureName: 'Wraith', zoneId: ZoneId.Zone5, archetypeId: CreatureArchetypeId.DimensionalElite, genericDropIds: ['black_mist', 'wraith_echo'], equipableItemId: 'wraith_mantle' },
  {
    creatureId: 'vortex_agent',
    creatureName: 'Agente Vórtex',
    zoneId: ZoneId.Zone1,
