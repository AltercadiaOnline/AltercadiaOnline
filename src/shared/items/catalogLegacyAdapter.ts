...
const CREATURE_BY_EQUIP_ID: Record<string, { creatureId: string; zoneId: ZoneId }> = {
  ...
  segmented_pants: { creatureId: 'centipede', zoneId: ZoneId.Zone2 },
  articulated_amulet: { creatureId: 'centipede', zoneId: ZoneId.Zone2 },
  electric_slime_ring: { creatureId: 'slime', zoneId: ZoneId.Zone2 },
  conductive_plate_armor: { creatureId: 'slime', zoneId: ZoneId.Zone2 },
  gel_fiber_pants: { creatureId: 'slime', zoneId: ZoneId.Zone2 },
  pulsing_rift_amulet: { creatureId: 'humanoid', zoneId: ZoneId.Zone2 },
  rift_woven_pants: { creatureId: 'humanoid', zoneId: ZoneId.Zone2 },
  molten_beam_amulet: { creatureId: 'golem', zoneId: ZoneId.Zone2 },
  molten_rail_helm: { creatureId: 'golem', zoneId: ZoneId.Zone2 },
  translucent_amulet: { creatureId: 'specter', zoneId: ZoneId.Zone2 },
