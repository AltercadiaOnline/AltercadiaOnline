...
import { enterPostBattleObservation, clearBattleObservationState } from '../battleObservationState.js';
import {
...
export const GameClient = {
  ...
  handleCombatDispatch(data: CombatDispatchPayload): void {
    ...
    hudManager.syncCombatantsFromState(
      data.state.combatants,
      data.ui.playerActorId,
      data.state.battleType,
    );
