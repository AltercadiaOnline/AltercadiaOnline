...
import { BATTLE_STAGE_FRAME_ID, BATTLE_STAGE_SCALE_ID, GAME_STAGE_FRAME_ID, GAME_STAGE_SCALE_ID, GAME_VIEWPORT_ID, } from '../../layout/gameLayout.js';
function resolveStageHosts() {
    ...
    return {
        visibleHost: document.getElementById(GAME_STAGE_FRAME_ID)
 ...
 */
export function useAlignHudFrameToGameStage(frameRef) {
    useEffect(() => {
