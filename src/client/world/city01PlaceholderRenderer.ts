...
import { getEntityDepthY, isCity01TowerAreaTile, resolveTowerStepHeightAtTile, } from '../../shared/world/localizedHeight.js';
import { drawPlaceholder, PlaceholderType, renderAsset, } from './placeholderRenderer.js';
 ...
 */
export function renderCity01PlaceholderGround(ctx, scene, camera) {
    ...
    for (let y = startY; y < endY; y++) {
        ...
        for (let x = startX; x < endX; x++) {
            ...
            const drawGround = (type, subX, subY, subSize) => {
...
export function collectCity01PlaceholderStructureDrawables(ctx, scene, options = {}) {
