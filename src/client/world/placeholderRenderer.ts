...
export const PLACEHOLDER_ASSET_REGISTRY: Readonly<Record<string, PlaceholderAssetDef>> = {
  ...
  npc_contrabandista: { type: PlaceholderType.NPC_SPOT, label: 'Contrabandista' },
  npc_receptador: { type: PlaceholderType.NPC_SPOT, label: 'Receptador' },
  npc_operario_linha4: { type: PlaceholderType.NPC_SPOT, label: 'Operário da Linha 4' },
  ...
  tree: { type: PlaceholderType.URBAN_PROP, label: 'Árvore' },
  arvore: { type: PlaceholderType.URBAN_PROP, label: 'Árvore' },
  tree_default: { type: PlaceholderType.URBAN_PROP, label: 'Árvore' },
  tree_blue_green: { type: PlaceholderType.URBAN_PROP, label: 'Árvore azul-esverdeada' },
  tree_willow: { type: PlaceholderType.URBAN_PROP, label: 'Salgueiro' },
  tree_mega: { type: PlaceholderType.URBAN_PROP, label: 'Mega árvore' },
  tree_luminous: { type: PlaceholderType.URBAN_PROP, label: 'Árvore luminosa' },
  tree_curved: { type: PlaceholderType.URBAN_PROP, label: 'Árvore curva' },
  tree_swirling: { type: PlaceholderType.URBAN_PROP, label: 'Árvore espiral' },
  tree_white: { type: PlaceholderType.URBAN_PROP, label: 'Árvore branca' },
  plant: { type: PlaceholderType.URBAN_PROP, label: 'Planta' },
  planta: { type: PlaceholderType.URBAN_PROP, label: 'Planta' },
  bush: { type: PlaceholderType.URBAN_PROP, label: 'Arbusto' },
  flor: { type: PlaceholderType.URBAN_PROP, label: 'Flor' },
  plant_default: { type: PlaceholderType.URBAN_PROP, label: 'Arbusto' },
  plant_bush_simple: { type: PlaceholderType.URBAN_PROP, label: 'Arbusto simples' },
  plant_bush_autumn: { type: PlaceholderType.URBAN_PROP, label: 'Arbusto outonal' },
  plant_bush_snow: { type: PlaceholderType.URBAN_PROP, label: 'Arbusto nevado' },
  plant_flower_blue: { type: PlaceholderType.URBAN_PROP, label: 'Flores azuis' },
  plant_flower_orange: { type: PlaceholderType.URBAN_PROP, label: 'Flores laranja' },
  plant_flower_pink: { type: PlaceholderType.URBAN_PROP, label: 'Flores rosas' },
  plant_flower_red: { type: PlaceholderType.URBAN_PROP, label: 'Flores vermelhas' },
  plant_fern: { type: PlaceholderType.URBAN_PROP, label: 'Samambaia' },
  plant_cactus: { type: PlaceholderType.URBAN_PROP, label: 'Cacto' },
  plant_cherry: { type: PlaceholderType.URBAN_PROP, label: 'Arbusto florido' },
};
