 ...
 */
export const CONSTRUCT_EXPORT_CONTRACT_VERSION = 2;
...
export const CONSTRUCT_EXPORT_REQUIRED_DIRS = ['scripts', 'images'];
/**
...
export const CONSTRUCT_LEAN_EXPORT_GUIDE = {
