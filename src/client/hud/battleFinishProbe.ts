...
export function traceBattleFinish(step, detail) {
...
export function getBattleFinishTrace() {
    return traceLog;
}
export function dumpBattleFinishTrace() {
    return traceLog
...
export function showBattleFinishDebugPanel(message, extra) {
...
export function installBattleFinishDebugGlobal() {
    ...
    w.__altercadiaBattleFinish = {
        ...
        probeDom: () => ({
            ...
            gameContainerDisplay: document.querySelector('#game-container')?.style.display ?? null,
        }),
    };
}
