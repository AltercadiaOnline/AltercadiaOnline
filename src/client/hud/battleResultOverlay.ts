...
export function buildBattleResultSummaryLines(payload, lootPreview) {
...
function resolveResultTitle(victory, endReason) {
    if (victory)
        return 'VITÓRIA';
    if (endReason === 'FORFEIT')
        return 'FUGA';
 ...
 */
export function showBattleResultOverlay(options) {
    ...
    return new Promise((resolve) => {
        ...
        title.className = `battle-result-panel__title ${options.victory
