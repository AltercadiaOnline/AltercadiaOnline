...
export function resolveTiledPublicAssetUrl(mapJsonUrl, tiledImagePath) {
...
export function resolveProcessedTilesetAtlasUrl(sourcePublicUrl) {
...
export function resolveTiledSourcePublicUrl(mapJsonUrl, tiledImagePath) {
