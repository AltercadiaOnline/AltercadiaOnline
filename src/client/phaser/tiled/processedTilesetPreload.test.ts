...
import { processedTilesetAtlasKeyFromSourceUrl, ROAD2_ATLAS_TEXTURE_KEY, ROAD2_SOURCE_PUBLIC_URL, } from './processedTilesetPreload.js';
describe('processedTilesetPreload', () => {
    it('deriva texture key do basename do PNG; Road2 usa road2_atlas', () => {
        ...
        expect(processedTilesetAtlasKeyFromSourceUrl('/assets/processed/tilesets/Road2.png')).toBe('road2_atlas');
