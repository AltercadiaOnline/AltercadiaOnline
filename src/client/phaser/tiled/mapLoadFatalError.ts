...
export function registerMapLoadFatalHandler(handler) {
...
export function formatTiledMapLoadMessage(mapId, issues) {
...
function mountFatalOverlay(mapId, issues) {
...
export function failTiledMapLoad(mapId, issues) {
