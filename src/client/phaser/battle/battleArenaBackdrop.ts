 ...
 */
const BACKDROP_BASE = '/assets/combat/background.batle/craftpix-891123-free-pixel-art-street-2d-backgrounds/PNG';
/** Cenas compostas (variante Bright) — uma por cidade. */
export const BATTLE_ARENA_BACKDROP_URLS = [
 ...
 */
export function resolveBattleArenaBackdropUrl(seed) {
