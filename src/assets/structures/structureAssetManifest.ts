...
export type StructureAssetSpec = {
...
export const STRUCTURE_IMAGE_URLS: Readonly<Record<string, string>> = Object.fromEntries(
  STRUCTURE_ASSET_SPECS.map((spec) => [
    spec.id,
