...
| 12 | Torre de Poder (raid: gate + andares 1–5, bosses, fama/buff) | [torre-poder.md](torre-poder.md) | `src/shared/tower/` + Construct `entradatorredopoder` / `andar_*_torre_poder*` + `public/assets/creatures/boss_tower_power/` |
