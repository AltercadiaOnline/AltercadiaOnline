...
export const PROJECTILE_FILE_BY_EFFECT = {
...
const VFX_PARTICLE_FILES = {
    impact_dust: 'impact_dust.png',
    hit_flash: 'hit_flash.png',
};
export function getProjectileAsset(effectType) {
...
export function getVfxAsset(particleId) {
...
export function getSkillIconAsset(skillId) {
